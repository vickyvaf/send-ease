...
Gunakan warna flat, tanpa gradient.
...
> Aturan:  
> - **Tidak** menggunakan gradient (linear/radial).  
> - Semua background dan elemen memakai warna flat dari daftar di atas.
...
- **Hierarchy:**
  - H1 (page title): 20–24px, semibold, warna `#27272A`
  - H2 (section title): 16–18px, semibold, warna `#27272A`
  - Body: 14–16px, regular, warna `#27272A`
  - Caption / helper text: 12–13px, regular, warna abu lebih muda (`#4B5563` opsional)

Tidak ada efek text gradient, gunakan warna solid saja.
...
- Aturan:
  ...
  - Card di dalam: background `#FFFFFF`, border `#E4E4E7` atau shadow ringan (flat).

Tujuannya: di desktop tetap terasa seperti app mobile di tengah layar, tanpa gradient.
...
- Background: `#FFFFFF`
- Border radius: 12px
- Border: 1px `#E4E4E7` atau shadow ringan (flat shadow, bukan gradient).
